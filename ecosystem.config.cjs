...
module.exports = {
  apps: [
    ...
    {
      name: "rastudio-history",
      script: "scripts/crm-history-worker.mjs",
      interpreter: "node",
      interpreter_args: "--max-old-space-size=512 --experimental-strip-types --import ./scripts/ts-ext-register.mjs",
      instances: 1,
      exec_mode: "fork",
      autorestart: true,
      max_restarts: 20,
