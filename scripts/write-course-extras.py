...
SLUG_TO_PATH = {
    ...
    "model-school-podium": "/model-school-podium",
    "model-school-makeup": "/model-school-makeup",
    "model-school-growth": "/model-school-growth",
...
ALT = {
    ...
    "/model-school-podium": "Модельная школа «Подиум» в Коломне",
    "/model-school-makeup": "Курс макияжа в студии «Развивайся»",
    "/model-school-growth": "Курс личностного роста в Коломне",
