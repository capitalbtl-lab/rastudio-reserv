...
const FALLBACKS = [
  {
    ...
    description:
      "Знакомство с живописью в рамках программы художественной школы \"Развивайся\" - это работа в различных техниках и с различными художественными материалами, способствующая целостному художественно-эстетическому развитию.",
...
const COURSE_ORDER = [
  ["/art-studio-9-13", "Художественная школа 10–15 лет"],
