...
export function TrialForm({
  ...
  return (
    <section id={compact ? undefined : "trial"} className="overflow-hidden rounded-[1.75rem] bg-surface px-5 py-8 shadow-[var(--shadow-border)] md:px-10 md:py-11">
      <div className={`grid gap-6 ${compact ? "" : "lg:grid-cols-[0.85fr_1.15fr] lg:items-stretch"}`}>
        <div>
        ...
        <div className="h-[min(36rem,75vh)] overflow-hidden rounded-2xl bg-bg">
