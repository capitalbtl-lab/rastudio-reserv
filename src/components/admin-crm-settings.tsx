...
const HINT = {
  ...
  recheckOnePeople: "Синяя очередь справа, по одному, пауза 5 с. Окно — список в этой же синей рамке (± месяц / ± три / ± шесть). Сравнивает номера, не голую цифру. Новое в окне дописывает, удалённое в окне снимает. Старше окна не ищет. Красную слева не запускает. Стоп после текущего. В Alfa не пишет.",
