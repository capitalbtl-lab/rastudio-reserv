...
const HINT = {
  ...
  plan: "Пульт — это не вторая очередь. Тумблер включает слоты по расписанию. Кнопка «Перепроверить шаги 1–5 сейчас» — та же очередь, но синяя перепроверка всех на диске, не «дыры слева». Окно — чипы лет. Пауза как у синей. «Стоп» на ленте шага. В Alfa ничего не пишет.",
