...
const HINT = {
  ...
  recheckCal: "Синяя этой карточки. Окно — список в синей рамке сверху (месяц / 3 / 6), не красная рамка. Сравнивает номера уроков в окне. Новые дописывает, ушедшие в окне снимает. Старше окна не трогает. Свои уроки и очередь не снимает. В Alfa не пишет.",
  recheckOnePeople: "Синяя очередь справа, по одному, пауза 5 с. Окно — список в этой же синей рамке. Сравнивает номера, не голую цифру. Новое в окне дописывает, удалённое в окне снимает. Старше окна не ищет. Красную слева не запускает. Стоп после текущего. В Alfa не пишет.",
  recheckWindow: "Только синие кнопки шага 2: массовая «Перепроверить по одному» и «Перепроверить» на зелёной карточке. Месяц ≈ 32 дня, три ≈ 92, шесть ≈ 182 — по дате урока. Красная рамка, медленный автодобор, «Добрать» и «вся история» это окно не берут. Дальше окна — красная или «С нуля». В Alfa не пишет.",
