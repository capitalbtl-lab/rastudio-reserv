...
const HINT = {
  ...
  years: "Только красные кнопки шага 2: массовая «Загрузить по одному», на карточке «Загрузить календарь» и «Добрать». Стоит в красной рамке. Не синяя, не медленный автодобор, не «вся история» (там всегда 2015), не «сверить счёт». По умолчанию «с начала · 2015». Короче — если человек ходит недавно. В Alfa ничего не отправляет.",
  ...
  recheckOneGroups: "Сначала правые группы, окно ±. Потом недогруженные слева (квартал, не окно). Кто добрался — снова справа тем же окном. Пауза 5 с. Стоп после текущей. В Alfa не пишет.",
  recheckOneMoney: "Сначала справа касса по id. Потом слева недочитанная. Кто дочитался — снова справа. Сумма — шаг 5. Журнал не качает. Пауза 5 с. Стоп после текущего. В Alfa не пишет.",
