...
const HINT = {
  ...
  tabStudents: "Второй шаг загрузки истории. Личный календарь: ученики и лиды из живых групп шага 1, одна очередь. Сначала список с диска, потом красной по одному. Жёлтая — в Alfa занятий больше. В Alfa не пишется. Деньги — следующий шаг, лидов туда не берём.",
