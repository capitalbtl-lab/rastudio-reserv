    ...
    <article className="flex flex-col rounded-2xl bg-surface p-4 shadow-[var(--shadow-border)]">
      <div className="mb-2 min-w-0">
        <div className="flex items-center gap-1.5">
          ...
          <InfoTip text="Текст этого шага попадает в системный промпт, пока слот не закрыт. Пишите коротко, одним вопросом. Карту ID и роли сюда не копируйте — База знаний и Окно." />
        </div>
