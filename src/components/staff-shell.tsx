...
import { AdminUpdateOverlay, useAdminLiveReload } from "@/components/admin-reload-btn";
    ...
    <div className="min-h-dvh bg-bg text-fg">
      <div className="flex h-12 items-center justify-between border-b border-black/10 px-4 text-sm">
        ...
        <div className="flex items-center gap-3">
          {live === "waiting" ? (
            <span className="text-[0.78rem] text-primary">Новая версия готова — обновлю, когда закончите ввод</span>
          ) : null}
