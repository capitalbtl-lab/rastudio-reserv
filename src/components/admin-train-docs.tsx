...
const CHANNEL_HINT: Record<string, string> = {
  ...
  phone: "Novofon: входящие звонки и SMS на /api/agent/phone. Кнопок нет, один вопрос за реплику. Ответ уходит SMS. Сюда — как называть филиалы вслух и что нельзя собирать по звонку.",
  vk: "Личка сообщества rastudio. Callback /api/agent/vk. Комментарий под постом — не место для ФИО и телефона: сначала в сообщения. Ссылки можно, голосовые кружки — нет.",
  max: "Бот MAX, webhook /api/agent/max. Голосовые вложения просим текстом или звонком на 8 800. Ссылки пишем целиком.",
      ...
      <article className="overflow-hidden rounded-[1.75rem] bg-surface shadow-[var(--shadow-border)]">
        <div className="border-b border-black/6 px-5 py-5 md:px-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-muted">
            Живой контур: сайт, ВК, MAX и Novofon. Один мозг читает столбец своего канала. Правила речи — в карточках ниже, ключи и webhook — Ассистент ИИ → Каналы.
          </p>
        </div>
