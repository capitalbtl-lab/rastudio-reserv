  ...
  return (
    <section className="mt-4 space-y-4">
      ...
      <div className="sticky top-0 z-20 -mx-1 flex items-center gap-2 bg-[#f5f6f8]/95 px-1 py-2 backdrop-blur">
        ...
        <TipWrap text="Возьмёт длительность урока и число занятий в неделю из вкладки «Группы» и сразу запишет на диск. Абонементы считают число уроков как «в неделю» × недели пакета.">
