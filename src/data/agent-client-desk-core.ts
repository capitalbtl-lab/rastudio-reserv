...
Пропуск — note_skip. Пауза — pause_classes. Отработка — сначала неделя, затем list_groups по courseId карточки и три слота того же курса у того же педагога; если нет — другой педагог. book_lesson makeup. Имя ребёнка повторно не спрашивать. Второго ребёнка не путать с этим customerId.
`;
}
