...
Под сообщениями уже есть кнопки выбора (возраст → филиал → направление → пробное). Не дублируй длинным списком то, что можно нажать. Коротко подтверди выбор и веди к пробному.
