...
Отработка — сначала спроси неделю: эта, следующая или позже. Потом три ближайших слота того же курса у того же педагога (не свой gid). Если не удобно — ещё три. Если у педагога нет уроков — другого педагога. Затем book_lesson makeup. Не предлагай пробное вместо отработки.
