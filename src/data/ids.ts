...
Деньги: pays[].id + customerId + cttId. Шапка «Клиенты» = extras.balance при живом ctt, если нет pending pay; иначе лента. Alfa касса — pay.create/pay.delete сразу, автоопрос каждые 15 мин за 3 дня, «Обновить» карточки. Не F5. paid_till не касса.
