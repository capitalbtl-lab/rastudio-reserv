...
export const BLOCK_LIBRARY: BlockType[] = [
  t("hero", "Первый экран", "система", [KICKER, TITLE, TEXT, IMAGES, CTA, HREF], true),
  t("ticker", "Бегущая строка", "система", [TEXT]),
  t("robot", "Видео курса", "курс", [TITLE, VIDEO]),
  t("ages", "Подбор по возрасту", "контент", [TITLE]),
  t("schools", "Карточки школ", "навигация", [TITLE]),
  t("catalog", "Сетка курсов", "курс", [TITLE]),
  t("about", "Текст и фото", "контент", [KICKER, TITLE, TEXT, IMAGE]),
  t("teachers", "Карточки педагогов", "контент", [TITLE]),
  t("reviews", "Лента отзывов", "контент", [TITLE]),
  t("stories", "Карточки событий", "контент", [TITLE, TEXT, IMAGE, CTA, HREF]),
  t("branches", "Карточки филиалов", "контент", [TITLE]),
  t("trial", "Блок записи", "курс", [TITLE, TEXT, COURSE]),
  t("course-hero", "Шапка страницы", "система", [KICKER, TITLE, TEXT, IMAGES, COURSE], true),
  t("convert-band", "Ближайшие группы", "курс", [TITLE, CTA, COURSE]),
  t("video-grid", "Видео под шапкой", "контент", [TITLE, VIDEO, COURSE]),
  t("course-story", "Рассказ", "контент", [TITLE, TEXT]),
  t("why", "Три причины", "контент", [TITLE, TEXT]),
  t("program", "Программа по шагам", "курс", [TITLE, TEXT, COURSE]),
  t("gallery", "Галерея фото", "контент", [IMAGES]),
  t("school-courses", "Список курсов", "курс", [TITLE, COURSE]),
  t("trajectory", "Ступени по возрастам", "курс", [TITLE]),
  t("page-reviews", "Отзывы", "контент", [TITLE]),
  t("schedule", "Расписание", "курс", [COURSE]),
  t("related", "Курсы того же возраста", "курс", [COURSE]),
  t("convert-aside", "Запись сбоку", "курс", [COURSE]),
  t("sell-why", "Результаты курса", "курс", [TEXT, COURSE]),
  t("sell-program", "Педагог и что дальше", "курс", [TEXT, COURSE]),
  t("trial-form", "Форма пробного", "курс", [TITLE, COURSE]),
  t("heading", "Заголовок", "контент", [TITLE]),
  t("rich-text", "Текст", "контент", [TEXT]),
  t("image", "Фото", "контент", [IMAGE, TITLE]),
  t("video", "Видео", "контент", [VIDEO, TITLE]),
  t("buttons", "Кнопка", "контент", [CTA, HREF]),
