...
/** Extra-типы качки без базового index. 3/5 возврат, 6 корректировка. 2 и 9 (товар) не качаем — ломают цифры сайта. */
...
/** Товар (типы 2 и 9 / commodity) в новую качку не берём. Старые строки на диске не трогаем этим хелпером. */
