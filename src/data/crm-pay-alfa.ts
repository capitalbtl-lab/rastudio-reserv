...
/** Только пары, которые видели в форме Alfa. Чужой филиал — id 0, в pay.create не уходит. */
export const ALFA_PAY_LOCATIONS: { id: number; branchId: number; name: string }[] = [
  ...
  { id: 0, branchId: 2, name: 'Студия "Развивайся" (г.Коломна, ЦМИТ, ул. Октябрьской революции, 340)' },
  { id: 0, branchId: 3, name: 'Студия "Развивайся" (г.Луховицы, ул. Пушкина, 202А)' },
  { id: 0, branchId: 4, name: "Летние программы" },
];
