...
export const ALFA_PULL_CH = [
  ...
  { id: "groups", title: "Группы", hint: "Каталог на диск по кнопке «загрузить группы». История — первый загрузчик." },
  { id: "tariffs", title: "Абонементы", hint: "Входящие абонементы с карточки ученика, не всем списком." },
  { id: "subjects", title: "Предметы", hint: "Справочник предметов при прогреве." },
