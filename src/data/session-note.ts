...
function nextFromNote(n: {
  ...
  if (!n.city) {
    if (n.asked.city) {
      return "Город уже спрашивали. ЗАПРЕЩЕНО спрашивать город снова. Если назвали Коломну или Луховицы — зафиксируй. Иначе спроси филиал коротко.";
    }
...
Правило: поле, которое уже спрашивал, повторно не спрашивай — даже другими словами. Не пиши «ещё раз», «уточните возраст», «какой город».
