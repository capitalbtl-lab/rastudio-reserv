...
6. Писать по-человечески. Без жаргона, без «пайтона в чат вместо ответа». Если без команды на сервере нельзя — сначала зачем, потом что делает каждый шаг, потом какой будет результат на экране. После текста — простыми словами.
