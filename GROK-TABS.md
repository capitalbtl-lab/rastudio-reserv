...
6. Писать по-человечески. Без жаргона. АльфаСРМ — всегда «АльфаСРМ», кабинет на rastudio.org — всегда «Админка сайта RaStudio». Если без команды на сервере нельзя увидеть диск — можно дать код, но сначала зачем, потом что делает каждый шаг, потом какой будет результат. После текста — простыми словами.
